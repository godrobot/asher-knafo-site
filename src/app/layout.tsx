  ...
  return (
    <html lang="he" dir="rtl">
      <body className="min-h-screen antialiased">
        ...
        />
        {/* Skip link for keyboard/screen-reader users, so they can bypass
            the header navigation and jump straight to the page content
            (WCAG 2.4.1 "Bypass Blocks"). Visually hidden until focused. */}
        <a
          href="#main-content"
          className="sr-only focus:not-sr-only focus:fixed focus:left-4 focus:top-4 focus:z-[100] focus:rounded-md focus:bg-gold-400 focus:px-4 focus:py-2 focus:text-sm focus:font-medium focus:text-sepia-950"
        >
          דלג לתוכן הראשי
        </a>
        <Header />
