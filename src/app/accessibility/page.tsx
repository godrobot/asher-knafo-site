      ...
      <div className="card-panel space-y-6 p-8 text-sm leading-7 text-sepia-200">
        ...
        <div>
          ...
          <p className="mt-2">
            ...
            באמצעות מקלדת, ושמירה על אינדיקציות מיקוד (focus) גלויות
            לרכיבים בני-לחיצה.
          </p>
        </div>
        ...
        <div>
          ...
          <p className="mt-2">
            האתר נמצא בתהליך שיפור נגישות מתמשך, ולא עבר בדיקת נגישות
            פורמלית על ידי גורם מוסמך חיצוני. ייתכן שקיימים חלקים שאינם
            עומדים באופן מלא בכל דרישות התקן. אנו מקבלים בברכה כל הערה
            שתסייע לנו לשפר.
          </p>
        </div>
